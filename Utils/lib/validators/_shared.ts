...
/**
 * Common pagination + sorting fields used across listing endpoints.
 * Spread directly into a z.object({}) definition:
 *
 *   export const myQuerySchema = z
 *     .object({ ...paginationQueryFields, search: safeString('search').optional() })
 *     .passthrough();
 */
...
/**
 * Extended pagination with common filter fields used by log-style endpoints.
 * Includes date range, userId, and period filters on top of pagination.
 */
export const logListQueryFields = {
