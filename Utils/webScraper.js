 ...
 */
async function scrapeWithRetry(url, parser, maxRetries = 2) {
 ...
 * Scrape Netmeds
 */
export async function scrapeNetmeds(query) {
 ...
 * Scrape Pharmeasy
 */
export async function scrapePharmeasy(query) {
 ...
 * Scrape 1mg
 */
export async function scrape1mg(query) {
 ...
 */
export async function scrapeDPCO(drugName) {
 ...
 */
export async function scrapeAllSources(query) {
