...
r.post("/create", adminMiddleware, uploadImage.single("imageUrl"), FeaturedMedicineService.createFeaturedMedicine);
r.get("/", FeaturedMedicineService.getFeaturedMedicines);
r.put("/:id", adminMiddleware, uploadImage.single("imageUrl"), FeaturedMedicineService.updateFeaturedMedicine);
r.delete("/:id", adminMiddleware, FeaturedMedicineService.deleteFeaturedMedicine);
// LOG ROUTES
