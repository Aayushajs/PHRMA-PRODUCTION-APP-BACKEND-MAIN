...
const r = router;
r.post("/create", adminMiddleware, uploadImage.fields([
...
r.put("/:id", adminMiddleware, uploadImage.fields([
    { name: "imageUrl", maxCount: CATEGORY_CONSTANTS.MAX_IMAGES },
    { name: "bannerUrl", maxCount: CATEGORY_CONSTANTS.MAX_BANNERS },
...
r.patch("/bulk/toggle-active", adminMiddleware, CategoryService.bulkToggleActive);
